...
namespace ONP.BackendProcessor.Tasks
{
    public class PlaceHoldReplacer
    {
        ...
        //public PlaceHoldReplacer(MessageTemplatesSettings settings)
        //{
        ...
        public string Replace(string template, IEnumerable<PlaceHolder> tokens, bool htmlEncode)
        {
