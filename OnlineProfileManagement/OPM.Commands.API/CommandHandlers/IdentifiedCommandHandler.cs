        ...
        public async Task<R> Handle(IdentifiedCommand<T, R> message, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    switch (command)
                    {
                        case CreateEntityProfileCommand createEntityProfileCommand:
                            idProperty = nameof(CreateEntityProfileCommand.EntityId);
                            //commandId = CreateEntityProfileCommand.EntityId;
                            commandId= nameof(CreateEntityProfileCommand.EntityId);
                            break;
                        ...
                        //TO-DO:
                        //More commands which should keep Idempotency.
