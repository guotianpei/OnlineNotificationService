...
namespace OPM.Commands.API.Infrastructure
{
    public class ProfileContextSeed
    {
        //public async Task SeedAsync(ProfileContext context, IWebHostEnvironment env, IOptions<OrderingSettings> settings, ILogger<OrderingContextSeed> logger)
        //{
